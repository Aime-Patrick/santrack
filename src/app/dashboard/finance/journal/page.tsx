...
import { useJournals } from "@/hooks/finance";
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold tracking-tight">General Journal</h1>
            <p className="text-sm text-muted-foreground">View and create journal entries.</p>
          </div>
        </div>
        <Button><Plus className="mr-2 size-4" /> New Entry</Button>
      </div>
